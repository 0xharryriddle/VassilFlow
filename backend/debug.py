...
Requirements:
    ...
    resolves vassilflow-harness and app packages correctly:
...
async def main():
    ...
    # Delay the rest of the VassilFlow imports until *after* logging is installed
    # so that any import-time side effects (e.g. vassilflow.agents starts a
