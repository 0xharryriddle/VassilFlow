...
VassilFlow tools annotate their runtime parameter as ``Runtime``
(``vassilflow.tools.types.Runtime`` = ``ToolRuntime[dict[str, Any], ThreadState]``)
...
tool call because the actual context VassilFlow installs is a dict. Using the
