...
def test_auth_post_rejects_cross_origin_browser_request():
    ...
    session fixation.
    """
    client = TestClient(_make_app(), base_url="https://vassilflow.example")
...
def test_auth_post_allows_same_origin_browser_request():
    ...
    response = client.post(
        "/api/v1/auth/login/local",
        headers={"Origin": "https://vassilflow.example"},
    )
...
def test_auth_post_rejects_malformed_origin_with_path():
    ...
    response = client.post(
        "/api/v1/auth/login/local",
        headers={"Origin": "https://vassilflow.example/path"},
    )
...
def test_auth_post_rejects_malformed_origin_with_invalid_port():
    ...
    response = client.post(
        "/api/v1/auth/login/local",
        headers={"Origin": "https://vassilflow.example:bad"},
    )
...
def test_auth_post_allows_same_origin_default_port_equivalence():
    ...
    response = client.post(
        "/api/v1/auth/login/local",
        headers={"Origin": "https://vassilflow.example:443"},
    )
...
def test_auth_post_allows_forwarded_same_origin():
    ...
    response = client.post(
        "/api/v1/auth/login/local",
        headers={
            "Origin": "https://vassilflow.example",
            "X-Forwarded-Proto": "https",
            "X-Forwarded-Host": "vassilflow.example, internal:8000",
        },
    )
...
def test_auth_post_allows_rfc_forwarded_same_origin():
    ...
    response = client.post(
        ...
        headers={
            "Origin": "https://vassilflow.example",
            "Forwarded": "proto=https;host=vassilflow.example",
        },
    )
