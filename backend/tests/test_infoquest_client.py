...
from vassilflow.community.infoquest import tools
from vassilflow.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("vassilflow.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("vassilflow.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("vassilflow.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # Regression source path intentionally omitted
