"""Tests for vassilflow.models.factory.create_chat_model."""
...
from vassilflow.models import factory as factory_module
from vassilflow.models import openai_codex_provider as codex_provider_module
...
def _make_app_config(models: list[ModelConfig]) -> AppConfig:
    return AppConfig(
        models=models,
        sandbox=SandboxConfig(use="vassilflow.sandbox.local:LocalSandboxProvider"),
    )
...
def test_create_chat_model_resolves_patched_mimo_provider(model_id):
    from vassilflow.models.patched_mimo import PatchedChatMiMo
