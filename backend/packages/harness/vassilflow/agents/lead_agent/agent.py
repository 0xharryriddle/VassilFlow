...
def build_middlewares(
    ...
    *,
    ...
    from vassilflow.agents.middlewares.skill_activation_middleware import SkillActivationMiddleware
    ...
    from vassilflow.agents.middlewares.system_message_coalescing_middleware import SystemMessageCoalescingMiddleware
...
def _load_enabled_skills_for_tool_policy(available_skills: set[str] | None, *, app_config: AppConfig) -> list[Skill]:
    try:
        from vassilflow.agents.lead_agent.prompt import get_enabled_skills_for_config
