...
- KEEP: Still likely valid, even if it was not mentioned in this conversation.
  Stable attributes such as native language, core expertise, and personality
  traits often remain true indefinitely.
...
The reason should cite what signal in the conversation, or absence of signal,
