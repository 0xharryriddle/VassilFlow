...
from vassilflow.config.title_config import get_title_config
...
class TitleMiddleware(AgentMiddleware[TitleMiddlewareState]):
    ...
    def _should_generate_title(self, state: TitleMiddlewareState, *, allow_partial_exchange: bool = False) -> bool:
        ...
        # Check if this is the first turn. The interrupted-run path can accept
        # a lone user message when the run is cancelled before any AI chunk is
        # checkpointed.
        messages = state.get("messages") or []
