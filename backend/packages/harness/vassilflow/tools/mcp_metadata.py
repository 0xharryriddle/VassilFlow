...
A tool is "MCP-sourced" when it carries the ``vassilflow_mcp`` metadata flag.
...
MCP_TOOL_METADATA_KEY = "vassilflow_mcp"
MCP_TOOL_ROUTING_METADATA_KEY = "vassilflow_mcp_routing"
...
def get_mcp_routing(tool: BaseTool) -> dict[str, Any] | None:
    """Return active routing metadata from an MCP-sourced tool."""
