...
from vassilflow.utils.network import get_free_port, release_port
...
def _resolve_docker_bind_host(sandbox_host: str | None = None, bind_host: str | None = None) -> str:
    ...
    same address family.
    """
    explicit_bind = bind_host if bind_host is not None else env_value("VASSILFLOW_SANDBOX_BIND_HOST")
    ...
    host = sandbox_host if sandbox_host is not None else env_value("VASSILFLOW_SANDBOX_HOST", "localhost")
...
class LocalContainerBackend(SandboxBackend):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            container_prefix: Prefix for container names (e.g., "vassilflow-sandbox").
    ...
    def create(
        ...
        *,
        ...
        sandbox_host = env_value("VASSILFLOW_SANDBOX_HOST", "localhost")
        return SandboxInfo(
