...
Usage::
    ...
    from vassilflow.runtime.checkpointer.provider import get_checkpointer, checkpointer_context
...
from vassilflow.config.checkpointer_config import CheckpointerConfig, ensure_config_loaded
...
POSTGRES_INSTALL = (
    "langgraph-checkpoint-postgres is required for the PostgreSQL checkpointer. Install the package extra with: pip install 'vassilflow-harness[postgres]' (or use: uv sync --all-packages --extra postgres when developing locally)"
)
