...
consumer side of this module lives in ``vassilflow.persistence.*``):
...
_current_user: Final[ContextVar[CurrentUser | None]] = ContextVar("vassilflow_current_user", default=None)
