...
class VassilFlowClient:
    """Embedded Python client for VassilFlow.
    ...
    def _ensure_agent(self, config: RunnableConfig):
        ...
        if checkpointer is None:
            from vassilflow.runtime.checkpointer import get_checkpointer
    ...
    def _ai_tool_calls_event(msg_id: str | None, tool_calls, additional_kwargs: dict[str, Any] | None = None) -> "StreamEvent":
        ...
        data: dict[str, Any] = {
            ...
            "content": "",
            "id": msg_id,
            "tool_calls": VassilFlowClient._serialize_tool_calls(tool_calls),
        }
        if additional_kwargs:
            data["additional_kwargs"] = additional_kwargs
        return StreamEvent(type="messages-tuple", data=data)
    ...
    def _serialize_message(msg) -> dict:
        ...
        if isinstance(msg, AIMessage):
            ...
            if msg.tool_calls:
                d["tool_calls"] = VassilFlowClient._serialize_tool_calls(msg.tool_calls)
    ...
    def list_threads(self, limit: int = 10) -> dict:
        ...
        checkpointer = self._checkpointer
        if checkpointer is None:
            from vassilflow.runtime.checkpointer.provider import get_checkpointer
    ...
    def get_memory(self) -> dict:
        ...
        """
        from vassilflow.agents.memory.updater import get_memory_data
    ...
    def import_memory(self, memory_data: dict) -> dict:
        ...
        from vassilflow.agents.memory.updater import import_memory_data
    ...
    def reload_memory(self) -> dict:
        ...
        """
        from vassilflow.agents.memory.updater import reload_memory_data

        return reload_memory_data(user_id=get_effective_user_id())

    def clear_memory(self) -> dict:
        """Clear all persisted memory data."""
        from vassilflow.agents.memory.updater import clear_memory_data
    ...
    def create_memory_fact(self, content: str, category: str = "context", confidence: float = 0.5) -> dict:
        ...
        from vassilflow.agents.memory.updater import create_memory_fact

        return create_memory_fact(content=content, category=category, confidence=confidence)

    def delete_memory_fact(self, fact_id: str) -> dict:
        """Delete a single fact from memory by fact id."""
        from vassilflow.agents.memory.updater import delete_memory_fact
    ...
    def update_memory_fact(
        ...
        from vassilflow.agents.memory.updater import update_memory_fact
    ...
    def delete_upload(self, thread_id: str, filename: str) -> dict:
        ...
        """
        from vassilflow.utils.file_conversion import CONVERTIBLE_EXTENSIONS
