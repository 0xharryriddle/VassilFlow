...
from vassilflow.agents.thread_state import SandboxStateField, ThreadDataState
from vassilflow.runtime.user_context import resolve_runtime_user_id
from vassilflow.sandbox import get_sandbox_provider
...
class SandboxMiddleware(AgentMiddleware[SandboxMiddlewareState]):
    ...
    #
    # Background:
    #   ``ensure_sandbox_initialized*`` in ``vassilflow.sandbox.tools`` mutates
