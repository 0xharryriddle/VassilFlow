...
class SandboxConfig(BaseModel):
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. vassilflow.sandbox.local:LocalSandboxProvider)",
    )
    ...
    bash_command_timeout: int = Field(
        ...
        description=(
            ...
            "Keeps a blocking foreground command such as an un-backgrounded server from hanging the turn; background processes return immediately."
        ),
    )
