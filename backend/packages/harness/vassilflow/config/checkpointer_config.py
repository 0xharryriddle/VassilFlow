...
class CheckpointerConfig(BaseModel):
    ...
    type: CheckpointerType = Field(
        ...
        "'postgres' persists to PostgreSQL (install with vassilflow-harness[postgres])."
    )
    connection_string: str | None = Field(
        ...
        "For sqlite, use a file path like '.vassilflow/checkpoints.db' or ':memory:' for in-memory. "
...
def ensure_config_loaded() -> None:
    ...
    from vassilflow.config.app_config import _app_config, get_app_config
