...
three-state semantics (see :mod:`vassilflow.runtime.user_context`):
...
from vassilflow.runtime.user_context import AUTO, _AutoSentinel
...
class ThreadMetaStore(abc.ABC):
    ...
    async def update_assistant_id(
        ...
        *,
        ...
        """Bind a thread to its canonical Agent identity."""
