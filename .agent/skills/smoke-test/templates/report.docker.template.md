...
|----------|------|----------|
| vassilflow-nginx | {{nginx_status}} | {{nginx_uptime}} |
| vassilflow-frontend | {{frontend_status}} | {{frontend_uptime}} |
| vassilflow-gateway | {{gateway_status}} | {{gateway_uptime}} |
...
### If the Test Passes
1. [ ] Visit http://localhost:2026 to start using VassilFlow
