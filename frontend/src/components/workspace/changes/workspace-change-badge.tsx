...
export function WorkspaceChangeBadge({
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <div className="border-border/70 bg-muted/20 mt-3 overflow-hidden rounded-lg border">
        <div className="border-border/70 flex items-center justify-between gap-3 border-b p-3">
          <div className="flex min-w-0 items-center gap-2.5">
            <div className="bg-background/80 flex size-10 shrink-0 items-center justify-center rounded-md">
