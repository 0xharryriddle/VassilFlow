...
description: VassilFlow App is the reference implementation of what a production VassilFlow experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  VassilFlow App is a complete Super Agent application built on top of VassilFlow
...
VassilFlow App is the reference implementation of what a production VassilFlow experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The VassilFlow App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, VassilFlow Harness                               |
| Reverse proxy     | nginx                                                                |
