...
description: This tutorial shows you how to enable and use VassilFlow's memory system so the agent remembers important information about you across multiple sessions.
---
...
This tutorial shows you how to enable and use VassilFlow's memory system so the agent remembers important information about you across multiple sessions.
...
Memory is stored in `backend/.vassilflow/memory.json`:

```bash
cat backend/.vassilflow/memory.json
```
...
```
backend/.vassilflow/agents/{agent_name}/memory.json
```
...
- [Deploy Your Own VassilFlow](/docs/tutorials/deploy-your-own-vassilflow)
