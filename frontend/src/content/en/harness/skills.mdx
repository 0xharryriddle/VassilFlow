...
VassilFlow ships with the following public skills:
...
- **Through the VassilFlow App UI**: the skills panel lets you toggle skills on and off.
...
VassilFlow includes an optional **skill evolution** feature that allows the agent to autonomously create and improve skills in the `skills/custom/` directory:
