...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes VassilFlow capable of real action, not just
  conversation.
</Callout>
...
VassilFlow supports three sandbox modes. Choose the one that fits your deployment:
...
sandbox:
  ...
  # Optional: container name prefix (default: vassilflow-sandbox)
...
| `.vassilflow/threads/{thread_id}/user-data/` | `/mnt/user-data/`                           | Read-write |
