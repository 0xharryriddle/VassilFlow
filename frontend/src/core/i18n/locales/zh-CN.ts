...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    statusDegraded: "部分可用",
    limitedAvailability: "该智能体的部分能力暂时不可用。",
  ...
  // Conversation
  conversation: {
    historyFailed: "无法加载较早的消息。当前对话仍然可用。",
    retryHistory: "重试加载历史",
    runFailed: "智能体未能完成此请求",
    restoreMessage: "恢复消息",
    restoredFiles: "包含已上传文件",
    submissionErrors: {
      authentication: "请检查服务器配置中的模型凭据，然后重新发送消息。",
      connection: "请检查网络连接和服务器状态，然后重新发送消息。",
      rateLimit: "模型暂时受到请求频率限制，请稍后重新发送消息。",
      unknown: "请查看服务器日志或尝试其他模型，然后重新发送消息。",
    },
    noMessages: "还没有消息",
