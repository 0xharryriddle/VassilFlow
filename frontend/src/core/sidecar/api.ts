...
// The find-then-create flow has no backend upsert. Coalesce concurrent creates
// for one parent thread so fast double-clicks cannot create duplicate sidecars.
